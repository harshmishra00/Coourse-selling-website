import { Purchase } from "/Users/harshmishra/Desktop/Course-selling-website/backend/modals/purchase.modal.js";
import { Course } from "/Users/harshmishra/Desktop/Course-selling-website/backend/modals/course.modals.js";
...
export const createCourse= async (req,res)=>{
    ...
    try {
        ...
        if(!allowedFormat.includes(image.mimetype)){
            return res.status(400).json({errors: "Invalid image fromat! Only JPG and PNG format image is allowed"});
        ...
        console.log(error)
        req.status(500).json({errors: "Error creating course"})
    }
};
...
export const deleteCourse=async (req, res)=>{
    ...
    try {
        ...
        return res.status(201).json({errors: "Course deleted sucessesfully"})
    } catch (error) {
